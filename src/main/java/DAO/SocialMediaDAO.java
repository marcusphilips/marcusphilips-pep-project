...
public class SocialMediaDAO {
    ...
    /**
     * Creates an account in the `account` database given an Account object where
     * the `account_ID` is generated by the
     * datatable. Returns a new Account object with the same parameters except with
     * the table's `account_ID` unless it failed
    ...
    /**
     * Logs in. Returns account type with its primary key `account_id` if successful
